                   ...
                   <td><input type="checkbox" name="id[]" class="checkbox" value="{!!$value->id!!}"></td>
                    <td>{!! $i++ !!}</td>
                     <td >{!!$value->name!!}</td>
                              ...
                              <td style="text-align: center;"> <button class="btn btn-primary btn-xs edit_bm   glyphicon glyphicon-blackboard chitietvanban"  data-toggle="modal" data-target="#modal_edit_keywork" value="{!!$value->id!!}"></button></td>
                              <td style="text-align: center;">
                                  <button class="btn btn-primary btn-xs edit_bm   glyphicon glyphicon-send tukhoavanban"  data-toggle="modal" data-target="#modal_edit_keywork" value="{!!$value->id!!}"></button>
